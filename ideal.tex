...
\begin{figure}[H]
\begin{center}
\includegraphics[width=60mm]{images/cstr.eps}
\end{center}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=60mm]{images/umsatz.eps}
\end{figure}
\begin{itemize}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=60mm]{images/reaktionszeit.eps}
\end{center}
\end{figure}
...
Wärmebilanz:
\[ \fbox{$\displaystyle \underbrace{\frac{dT}{dz}}_{\mbox{Konvektion}}=\frac{1}{u\rho c_p}\underbrace{\left(\sum_{j}\left(-\Delta H_j\right)r_j\right.}_{\mbox{Wärmequelle/-senke}}-\underbrace{\left.k_W\frac{A}{V}\left(T-T_K\right)\right)}_{\mbox{Wärmetransport}}$} \]
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=80mm]{images/system.eps}
\end{center}
\end{figure}
